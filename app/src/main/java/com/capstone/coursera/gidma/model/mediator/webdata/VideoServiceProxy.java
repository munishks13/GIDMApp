...
public interface VideoServiceProxy {
    ...
    // The path where we expect the VideoSvc to live
    public static final String VIDEO_DATA_PATH = VIDEO_SVC_PATH + "/{" + VideoServiceProxy.ID_PARAMETER + "}/data";

    public static final String LOGIN_CHECK = "/checkValidLogin";
    ...
    public AverageVideoRating rateVideo(@Path("id") long id, @Path("rating") double rating);
